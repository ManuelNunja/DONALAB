...
VALUES((SELECT ENTI_ID FROM SEGURIDAD.ENTIDAD WHERE ENTI_RAZON_SOCIAL = 'SISTEMAS ANALÍTICOS'), 'LNUNJA','123', 'MANUEL', 'NUNJA', 'ASTACIO', GETDATE(), '0.0.0.0')

/*
SE DEBEN ACTUALIZAR LOS FOREIGN KEY DE LAS TABLAS CREADAS EN ESTE SCRIPT
*/